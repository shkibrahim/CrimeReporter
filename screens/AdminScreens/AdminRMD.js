...
var Accept = () => {
    ...
    if(selectedDate == null || selectedTime == null ||DocumentInformation == null ||  Location == null )
    {
alert ('Fill the form')
    }
else{
