...
const AdminSolvedCases = ({navigation}) => {
      ...
      <View style={{alignItems: 'center', width: 400}}>
        <View
          ...
          <View
            ...
            disabled = {true}
             >
              <Text style={{fontSize:20, marginLeft:123, fontWeight:'bold', color:'white', marginTop:9, alignContent:'center'}}>Solved Cases</Text>
            </TouchableOpacity>
          </View>
...
export default AdminSolvedCases;
