...
const UserNVMC = ({routes, navigation}) => {
  ...
  var MISSINGCRIMINALNOTIFICATION = firestore().collection('MISSINGCRIMINALNOTIFICATION');

  useEffect(() => {
    var Dataa = async () => {
      await MISSINGCRIMINALNOTIFICATION.get().then(data => {
      ...
      <View style={{alignItems: 'center', width: 400}}>
        ...
        <Text
                     ...
                     User Name
                        ...
                        <View style ={{backgroundColor:  '#eceded',  borderRadius: 10, width: 350,
                height:40, marginLeft:10, paddingHorizontal: 10,
                marginBottom:30,
                marginVertical: 10,}}>
                        <TextInput
                          style={{
                ...
                marginVertical: 10,}}>
                       ...
                       onChangeText={setUserInformation}
                        />
                        </View>
                        <TouchableOpacity
            style={{
           ...
           onPress={()=>Update(item)}
           >
            <Text style={{color: 'white', fontSize:16, marginTop: 11, fontWeight:'bold'}}>
           UPDATE
            </Text>
          </TouchableOpacity>
                        </ScrollView>
